...
|11| [Стратегическое ценообразование в конкурентной среде с использованием теории игр][11]| Этот проект представляет модель стратегического ценообразования для нескольких компаний, используя подходы теории игр.
...
Проект написан на языке Python и включает в себя простой симулятор взаимодействий компаний в конкурентной среде. Компании выбирают свои цены на основе текущего состояния рынка, стремясь максимизировать свою прибыль. |Python, NumPy, Matplotlib, Seaborn|
